    ...
    return (
        <div className='w-full flex flex-col items-center' >
            ...
            <div className='bg-white flex flex-col w-full md:w-1/2 space-y-6 my-4 py-4 items-center' >
                ...
                <aside className='text-xl justify-center flex flex-row items-center space-x-1 text-blue-600 '>
                    <AiOutlineInfoCircle />
                    <span className='text-lg font-semibold' >Status of the package</span>
                    <BsChevronDown className='pt-1' /> </aside>
